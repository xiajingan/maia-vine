...
| VINE-002 | 作为 Celt，我希望与 H5 完成版本化 Bridge 握手。 | 能力协商、超时、错误和重连明确；未知方法默认拒绝。 | FND-020/CEL-005 | `draft` |
...
| VINE-011 | 作为 Celt，我希望 Bridge 消息不可重放。 | challenge/nonce/双向 sequence/correlation/MAC；旧页面、乱序和伪造来源拒绝。 | FND-020/CEL-005 | `draft` |
